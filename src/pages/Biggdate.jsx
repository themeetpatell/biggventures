    ...
    <div className="pt-16 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <span className="bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Biggdate</span>
          </motion.h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-slate-300 text-lg mb-4">
              Building alone is hard. Biggdate connects you with co-founders who share your vision, complement your skills, and align with your values.
            </p>
