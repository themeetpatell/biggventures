    ...
    <footer className="border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div>
            <h3 className="text-xl font-bold text-gradient mb-4">Biggbizz</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li><Link to="/peopleos" className="hover:text-purple-400 transition">PeopleOS</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><Link to="/relationos" className="hover:text-purple-400 transition">RelationOS</Link></li>
              <li><Link to="/lifeos" className="hover:text-purple-400 transition">LifeOS</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-500">© 2025 Biggbizz Universe. Building the future of startup infrastructure.</p>
